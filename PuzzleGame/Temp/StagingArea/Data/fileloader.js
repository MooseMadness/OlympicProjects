...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 4232703;
      var PACKAGE_UUID = '7420a3e4-0e29-4a6b-b64d-be1393718060';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 19988, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(19988, 31348, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(31348, 169732, 0, 0).open('GET', '/level0');
    new DataRequest(169732, 176304, 0, 0).open('GET', '/level1');
    new DataRequest(176304, 176325, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(176325, 179430, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(179430, 809234, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(809234, 837350, 0, 0).open('GET', '/sharedassets1.assets');
    new DataRequest(837350, 2646978, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2646978, 4144350, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(4144350, 4205078, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(4205078, 4232703, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
